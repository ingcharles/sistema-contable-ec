...
// export { RRHHUseCases as RRHHUseCases } from '@/modules/rrhh/application/useCases/RRHHUseCases';
export { RRHHUseCases } from '@/modules/rrhh/application/useCases/RRHHUseCases';
