    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-xl shadow-sm border border-slate-100">
                <div>
                    <h1 className="text-2xl font-bold text-slate-800">Libro Diario y Asientos</h1>
                    <p className="text-slate-500 text-sm mt-1">Gestión de asientos contables automáticos y manuales.</p>
                </div>
            </div>
