...
import { LayoutDashboard, FileText, ShoppingCart, TrendingUp, Users, Settings, PieChart, Landmark, Package, Wallet, FileBarChart, Contact2, Monitor, UploadCloud } from 'lucide-react';
...
export const PLAN_CUENTAS: CuentaContable[] = [
  ...
  { codigo: '2.1.03', nombre: 'OBLIGACIONES IESS', nivel: 3, tipo: 'PASIVO', saldo: 5000 },
];
